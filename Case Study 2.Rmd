...
In this case we are not considering qd4 and qd23, of course the intention of re-purchase is not considered among the predictor. The dependent variable is the factor for willingness to pay.
...
The predictors resulting significant are (in this order) "Ease of Use" with a 0.18 coefficient. Serviceability and Features are the most relevant factors. Performance and Quality of materials have a 99% significance level.
