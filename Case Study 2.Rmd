...
```{r}
PCA <- principal(df1[, -c(4, 23)], nfactors = 8, rotate = "varimax")
sort(PCA$communality)
# print(PCA$loadings, cutoff = 0.3, sort = TRUE)
PCA <- principal(df1, nfactors = 10, rotate = "varimax")
sort(PCA$communality)
# print(PCA$loadings, cutoff = 0.3, sort = TRUE)
```
